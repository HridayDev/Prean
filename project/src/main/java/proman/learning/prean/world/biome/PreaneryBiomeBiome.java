...
package proman.learning.prean.world.biome;
...
public class PreaneryBiomeBiome extends PreanModElements.ModElement {

	public static Biome biome;

	public PreaneryBiomeBiome(PreanModElements instance) {
		super(instance, 23);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(PreanBlockBlock.block.getDefaultState(),
								PreanOreBlock.block.getDefaultState(), PreanOreBlock.block.getDefaultState())));

				biomeGenerationSettings.withStructure(StructureFeatures.VILLAGE_PLAINS);

				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(PreanBlockBlock.block.getDefaultState()),
								new SimpleBlockStateProvider(PreanOreBlock.block.getDefaultState()),
				...
				mobSpawnInfo.withSpawner(EntityClassification.AMBIENT, new MobSpawnInfo.Spawners(EntityType.ZOMBIE, 20, 10, 10));
				...
				event.getRegistry().register(biome.setRegistryName("prean:preanery_biome"));
			}
		}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("preanery_biome_lvtd");
		...
		protected void func_227424_a_(IWorldWriter ww, BlockPos bp, BooleanProperty bpr, Set<BlockPos> sbc, MutableBoundingBox mbb) {
			this.func_227423_a_(ww, bp, PreanBlockBlock.block.getDefaultState(), sbc, mbb);
		}
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("preanery_biome_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("preanery_biome_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
