...
package proman.learning.prean.entity;

import net.minecraft.block.material.Material;

@PreanModElements.ModElement.Tag
public class PreanerBossEntity extends PreanModElements.ModElement {

	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).immuneToFire()
			.size(10f, 10f)).build("preaner_boss").setRegistryName("preaner_boss");

	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("entitybulletpreaner_boss").setRegistryName("entitybulletpreaner_boss");

	public PreanerBossEntity(PreanModElements instance) {
		super(instance, 34);

		FMLJavaModLoadingContext.get().getModEventBus().register(new PreanerBossRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -39424, -16777012, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("preaner_boss_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			setCustomName(new StringTextComponent("Preaner Boss"));
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(PreanBlockBlock.block));
		}
		...
		public void livingTick() {
			...
			if (true)
				for (int l = 0; l < 4; ++l) {
					...
					world.addParticle(ParticleTypes.SPIT, d0, d1, d2, 0, 0, 0);
				}
		}
	...
	private static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(PreanSwordItem.block);
		}
