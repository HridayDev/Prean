...
@OnlyIn(Dist.CLIENT)
public class PreanerBossRenderer {
	...
	public static class ModelRegisterHandler {
		...
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(PreanerBossEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelcustom_model(), 10f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("prean:textures/texture.png");
					}
				};
			});

			RenderingRegistry.registerEntityRenderingHandler(PreanerBossEntity.arrow,
